...
<div class="row">
    ...
    <?php echo $form->textField($model, 'titleMain', array('size' => 45, 'maxlength' => 100)); ?>
    <?php echo $form->error($model, 'titleMain'); ?>
</div>

<div class="row">
    <?php echo $form->labelEx($model, 'titleAdd'); ?>
    <?php echo $form->textField($model, 'titleAdd', array('size' => 45, 'maxlength' => 100)); ?>
    <?php echo $form->error($model, 'titleAdd'); ?>
</div>

<div class="row">
    <?php echo $form->labelEx($model, 'titleRus'); ?>
    <?php echo $form->textField($model, 'titleRus', array('size' => 45, 'maxlength' => 100)); ?>
